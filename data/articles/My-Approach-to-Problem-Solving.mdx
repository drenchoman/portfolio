...
excerpt: 'My approach to problem solving when coding and some techniques that I have come across.'
image: 'https://res.cloudinary.com/dbyprqeyc/image/upload/v1672205417/gorilla_amqant.jpg'
isPublished: true
author: 'Oscar Harron'
tags:
  - Web Dev
...
<div className="inBlogImage">
  <Image
    src={'https://res.cloudinary.com/dbyprqeyc/image/upload/v1673826075/blog/my-approach/problem_lwsrsj.jpg'}
...
<div className="inBlogImage">
  <Image
    src={'https://res.cloudinary.com/dbyprqeyc/image/upload/v1673826075/blog/my-approach/nonworkingcode_ac4p13.jpg'}
    alt="My non working code"
    fill
    style={{ objectFit: 'contain' }}
...
<div className="inBlogImage">
  <Image
    src={'https://res.cloudinary.com/dbyprqeyc/image/upload/v1673826075/blog/my-approach/workingcode_qzx915.jpg'}
    alt="My non working code"
    fill
    style={{ objectFit: 'contain' }}
    alt="My nonworkingcode"
...
<div className="inBlogImage">
  <Image
    src={'https://res.cloudinary.com/dbyprqeyc/image/upload/v1673826075/blog/my-approach/fizzbuzz_jvigtd.jpg'}
    alt="My non working code"
    fill
    style={{ objectFit: 'contain' }}
    alt="My nonworkingcode"
